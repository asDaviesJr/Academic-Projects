...
class EditClub extends Component{
    ...
    constructor(props){
        super(props); 
        let values = {club_name: this.props.club_name,city:this.props.city, music_genre:this.props.music_genre, max_occ:this.props.max, thres_occ:0}; 
    ...
    render() {
        return (
            <div>
                ...
                <ModalFooter>
                    <Button color='success' onClick={this.onEdit}>Save</Button>
                </ModalFooter>
